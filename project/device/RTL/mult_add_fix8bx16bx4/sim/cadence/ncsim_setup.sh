...
TOP_LEVEL_NAME="mult_add_fix8bx16bx4.mult_add_fix8bx16bx4"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/share/eda/AOCL/altera/18.0_pro//quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [mult_add_fix8bx16bx4::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [mult_add_fix8bx16bx4::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set libraries [dict merge $libraries [mult_add_fix8bx16bx4::get_design_libraries]]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set design_files [dict merge $design_files [mult_add_fix8bx16bx4::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/ncsim_files.tcl
set files [concat $files [mult_add_fix8bx16bx4::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
