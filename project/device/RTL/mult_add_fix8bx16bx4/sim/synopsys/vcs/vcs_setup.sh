...
TOP_LEVEL_NAME="mult_add_fix8bx16bx4"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [mult_add_fix8bx16bx4::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {mult_add_fix8bx16bx4::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [mult_add_fix8bx16bx4::get_design_files "$QSYS_SIMDIR"]]
