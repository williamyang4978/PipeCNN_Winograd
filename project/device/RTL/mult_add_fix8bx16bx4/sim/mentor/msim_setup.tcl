...
# ----------------------------------------
# If mult_add_fix8bx16bx4 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0.1 261 linux 2019.01.25.15:45:10
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mult_add_fix8bx16bx4.mult_add_fix8bx16bx4"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/share/eda/AOCL/altera/18.0_pro//quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mult_add_fix8bx16bx4::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [mult_add_fix8bx16bx4::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [mult_add_fix8bx16bx4::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [mult_add_fix8bx16bx4::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [mult_add_fix8bx16bx4::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [mult_add_fix8bx16bx4::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [mult_add_fix8bx16bx4::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
